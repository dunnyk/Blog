...
class LoginSerializer(serializers.Serializer):
    ...
    )  # here write_only means you can't copy paste data, just writing
    ...
    def validate(data):
        ...
        # user_token = authenticate(email, password)
...
class UserRetriveUpdateSerializer(serializers.ModelSerializer):
    ...
    username = serializers.RegexField(
        ...
        error_messages={"invalid": error_dict["invalid_name"].format("Username")},
    )
